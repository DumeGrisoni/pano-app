...
export function AddProjectForm({
  ...
  async function onSubmit(data: z.output<typeof formSchema>) {
    ...
    const isUrgentData = data.isUrgent || diffDays <= 7;
    ...
    <Card className="w-full max-w-[80%] md:max-w-[99%] mx-auto">
      <CardHeader className="text-center flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <CardDescription>
            Entrez les informations relatives au projet à ajouter
          </CardDescription>
        </div>

        <div className="flex flex-row items-center justify-center gap-8">
          <div className="flex flex-col items-center gap-2">
            <label htmlFor="isFile" className="text-sm font-medium">
              Fichier Fourni
            </label>
            <Switch id="isFile" checked={isFile} onCheckedChange={setIsFile} />
          </div>

          <div className="flex flex-col items-center gap-2">
            <label htmlFor="isBAT" className="text-sm font-medium">
              BAT Validé
            </label>
            <Switch id="isBAT" checked={isBAT} onCheckedChange={setIsBAT} />
          </div>
        </div>
      </CardHeader>
          ...
          <FieldGroup>
            ...
            <div className="mb-6 border rounded-md p-4 w-full shadow-sm flex flex-col gap-6">
              ...
              <div className="grid grid-cols-[minmax(300px,1fr)_50px_120px_120px_100px_60px] gap-4 text-xs font-semibold text-muted-foreground items-center">
                <div>Produit</div>
                <div>Qté</div>
                <div>Option 1 / Hauteur</div>
                <div>Option 2 / Longueur</div>
                <div>Total</div>
                <div></div>
              </div>
                    ...
                    <div className="grid grid-cols-[minmax(300px,1fr)_50px_120px_120px_100px_60px] gap-4 items-center">
                      ...
                      {needsDimensions ? (
                        <>
                          ...
                          <input
                            className="w-full h-10 rounded-md border px-2 disabled:bg-slate-50"
                            type="number"
                            placeholder="Hauteur"
                            value={item.height}
                            onChange={(e) => {
                ...
                {(filtered) => (
                  <div className="flex flex-col gap-2 mt-2">
                    ...
                    {filtered.map((product) => {
                      ...
                      const productHasMedia = productHasType(product, 'media');
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            copy[selectedIndex] = {
                              ...
                              unit_multiplier:
                                ((product as any).unit_multiplier as number) ??
                                1,
                              ...
                              plastifEnabled: needsPlastif ? false : undefined,
